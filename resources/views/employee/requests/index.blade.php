                    ...
                    <tr>
                        <td>
                            <div class="request-type">
                                <i class="fas fa-{{ $request->request_type === 'shift' ? 'clock' : 'question-circle' }}"></i>
                                <span>{{ ucfirst($request->request_type ?? 'Shift') }}</span>
                            </div>
                        </td>
                        <td>
                            <div class="request-description">{{ $request->description ?? 'Shift request for ' . $request->shift_date->format('M d, Y') }}</div>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="badge-custom badge-{{ $request->status === 'accepted' ? 'success' : ($request->status === 'pending' ? 'warning' : 'danger') }}">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <div class="empty-state-subtext">Your shift requests and other submissions will appear here</div>
                            </div>
                        </td>
                    </tr>
                    @endforelse
